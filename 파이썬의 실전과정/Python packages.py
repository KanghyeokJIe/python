...
from game.sound.echo import echo_test as e      # as 를 이용하여 echo_test 함수를 간단히 e 로 줄여서 사용 가능 하다.

e()         ## Result : echo

# __all__

from game.sound import *        # * 를 이용하여 모든 함수를 가져 올 수 있으나 오류가 걸린다.
...
# from ..sound.echo import echo_test / ..은 상대경로에서 이전 폴더를 의미 한다.
